...
|1차 릴리즈|                             스플래시, 온보딩, 피드 생성, <br> 댓글 생성/삭제, 회원 탈퇴                              |                                    위니 피드, 상세 피드, <br> 마이 피드, 댓글 조회                                    |                                    카카오 로그인, 마이페이지, <br> 추천 피드, 알림 목록                                     |
|2차 릴리즈|위니/상세/마이 피드 UI 수정 <br> 목표 여정 | 마이페이지 전면 수정 <br> 설정 화면 | FCM 푸시 알림 |
